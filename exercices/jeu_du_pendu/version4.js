function game(){
    ...
    let urlImage = '/img/pendu000.png';
    principal.style.marginTop = '35vh';

    while (principal.firstChild) principal.removeChild(principal.firstChild);
        principal.innerHTML = `
        <h2>nombre de lettres du mot à chercher ?</h2>
            <div class ='container'>
        ...
        let huitLettre = document.getElementById('huit');
        huitLettre.addEventListener('click', () => {
            mot = mots_8;
            newGame();
        });
        let neufLettre = document.getElementById('neuf');
        neufLettre.addEventListener('click', () => {
            mot = mots_9;
            newGame();
        });
        let dixLettre = document.getElementById('dix');
        dixLettre.addEventListener('click', () => {
            mot = mots_10;
            newGame();
        });  
    ...
    function newGame(){
        ...
        let hasard = parseInt(Math.random() * (mot.length - 0) + 0);
    ...
    function choisirLettre(){
        //Boucle do... while
        do{
            lettreJoueur = prompt(`Choisissez une lettre`);
    ...
    function refresh(){
        principal.style.marginTop = '13vh';
        switch(score){
            case 0:
                urlImage = '/img/pendu010.png';
                break;
            case 1:
                urlImage = '/img/pendu009.png';
                break;
            case 2:
                urlImage = '/img/pendu008.png';
                break;
            case 3:
                urlImage = '/img/pendu007.png';
                break;
            case 4:
                urlImage = '/img/pendu006.png';
                break;
            case 5:
                urlImage = '/img/pendu005.png';
                break;
            case 6:
                urlImage = '/img/pendu004.png';
                break;
            case 7:
                urlImage = '/img/pendu003.png';
                break;
            case 8:
                urlImage = '/img/pendu002.png';
                break;
            case 9:
                urlImage = '/img/pendu001.png';
                break;
            case 10:
                urlImage = '/img/pendu000.png';
                break;
        }
        while (principal.firstChild) principal.removeChild(principal.firstChild);
        principal.innerHTML = `
        <div class='containerJeu'>
            <div>
                <h2>Lettres trouvéés</h2>
                <h3>${tableaulettre.join(" ")}
            </div>
            <div>
